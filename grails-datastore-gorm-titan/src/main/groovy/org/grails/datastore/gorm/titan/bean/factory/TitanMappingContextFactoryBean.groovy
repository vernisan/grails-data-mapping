 ...
 */
class TitanMappingContextFactoryBean extends AbstractMappingContextFactoryBean {

    protected MappingContext createMappingContext() {
        new TitanMappingContext(proxyFactory: new HashcodeEqualsAwareProxyFactory())
    }
}
