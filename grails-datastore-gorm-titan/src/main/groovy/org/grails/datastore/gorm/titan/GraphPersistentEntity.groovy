...
import org.grails.datastore.gorm.titan.mapping.config.TitanEntity
...
public class GraphPersistentEntity extends AbstractPersistentEntity<Entity> {
    ...
    protected TitanEntity mappedForm;

    public GraphPersistentEntity(Class javaClass, MappingContext context) {
        super(javaClass, context);
        this.mappedForm = (TitanEntity) context.getMappingFactory().createMappedForm(this);
    }
