...
public abstract class DirtyCheckableAwareCollection<T> implements Collection<T> {
    ...
    private final TitanSession session;
    private final boolean reversed;
    private final String relType;

    protected DirtyCheckableAwareCollection(EntityAccess owner, Association association, Collection<T> delegate, TitanSession session) {
        this.owner = owner;
