...
import org.grails.datastore.gorm.titan.TitanTransaction;
 ...
 */
public class TitanSession extends AbstractSession<ExecutionEngine> {

    private static Logger log = LoggerFactory.getLogger(TitanSession.class);
    ...
    public TitanSession(Datastore datastore, MappingContext mappingContext, ApplicationEventPublisher publisher, boolean stateless, CypherEngine cypherEngine) {
    ...
    protected Persister createPersister(Class cls, MappingContext mappingContext) {
        ...
        return (entity != null ) ? new TitanEntityPersister(mappingContext, entity, this, publisher) : null;
    }

    @Override
    protected Transaction beginTransactionInternal() {
        return new TitanTransaction(cypherEngine);
    }

    @Override
    public TitanDatastore getDatastore() {
        return (TitanDatastore) super.getDatastore();
    }
