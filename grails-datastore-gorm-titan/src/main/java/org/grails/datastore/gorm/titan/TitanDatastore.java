 ...
 */
public class TitanDatastore extends AbstractDatastore implements InitializingBean, DisposableBean, StatelessDatastore {

    private static Logger log = LoggerFactory.getLogger(TitanDatastore.class);
    ...
    public TitanDatastore(MappingContext mappingContext, ApplicationContext applicationContext, CypherEngine cypherEngine) {
    ...
    protected Session createSession(Map<String, String> connectionDetails) {
        return new TitanSession(this, mappingContext, getApplicationContext(), false, cypherEngine);
    }
